#!/bin/bash
# Qwen3: all papers, portrait (36×48) then landscape (48×36)
# Requires vLLM servers to be running: bash scripts/start_vllm_qwen3.sh
# Usage: bash scripts/run_qwen3.sh
...
run_papers() {
  ...
  echo ""
  echo "======================================================"
  echo "  $LABEL — ${#PAPERS[@]} papers  [Qwen3]"
  echo "  $(date)"
  echo "======================================================"
