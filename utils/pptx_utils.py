...
def add_textbox(
    ...
    if is_title is not None:
        text_frame.margin_top = Pt(is_title)
    else:
        text_frame.margin_top = Pt(-5)
        
    text_frame.margin_bottom = Pt(10)
    text_frame.margin_left = Pt(15)  # A small horizontal margin improves readability.
...
def fill_textframe(shape, paragraphs_spec):
    ...
    for p_data in paragraphs_spec:
        ...
        default_font_name = p_data.get("font_name", "Arial")
